...
def datingClassTest():
    ...
    for i in range(numTestVecs):
        classifierResult = classify0(normMat[i,:],normMat[numTestVecs:m,:],datingLabels[numTestVecs:m],3) # KNN=3
...
def handwritingClassTest():
    ...
    for i in range(mTest):
        ...
        fileStr = fileNameStr.split('.')[0]     #take off .txt
        classNumStr = int(fileStr.split('_')[0])
        vectorUnderTest = img2vector('testDigits/%s' % fileNameStr)  #文本值已经在0-1之间，不需要归一化
